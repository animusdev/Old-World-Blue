...
var/list/all_supply_groups = list(
	"Operations","Security","Hospitality","Engineering","Atmospherics","Medical",\
	"Reagents","Reagent Cartridges","Science","Hydroponics", "Supply", "Miscellaneous"
)
