/datum/power/changeling/space_suit
	...
	genomecost = 1
	verbpath = /mob/living/proc/changeling_spacesuit

/mob/living/proc/changeling_spacesuit()
...
/datum/power/changeling/armor
	...
	genomecost = 3
	verbpath = /mob/living/proc/changeling_spacearmor

/mob/living/proc/changeling_spacearmor()
	set category = "Changeling"
