...
/obj/structure/closet/secure_closet/cabinet/detective
	...
	New()
		...
		new /obj/item/clothing/under/rank/det/slob(src)
		if(prob(50))
...
/obj/structure/closet/secure_closet/cabinet/forentech
	...
	New()
		...
		new /obj/item/clothing/under/rank/det/seven(src)
		new /obj/item/clothing/under/rank/det/forentech(src)
		new /obj/item/clothing/under/rank/det/forentech2(src)
		new /obj/item/clothing/suit/storage/forensics/blue(src)
		new /obj/item/clothing/suit/storage/forensics/red(src)
		new /obj/item/clothing/suit/storage/toggle/labcoat/forensic(src)
		new /obj/item/clothing/under/rank/det/formal(src)
